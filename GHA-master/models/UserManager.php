...
*/
    ...
    */
    ...
    public function verifyUser($uid){
        $this->getBdd();
        $query="UPDATE users SET user_verified=1 WHERE user_id=:uid";
        $req = $this::$_bdd->prepare($query);
        $res = $req->execute([
            "uid"=>$uid
        ]);
    ...
    public function unVerifyUser($uid){
        $this->getBdd();
        $query="UPDATE users SET user_verified=0 WHERE user_id=:uid";
        $req = $this::$_bdd->prepare($query);
        $res = $req->execute([
            "uid"=>$uid
        ]);
        ...
        public function deleteUser($uid){
            ...
            $publisherManager->deletePublisherByUserId($uid);
