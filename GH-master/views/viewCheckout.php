...
if (!isset($userData) || (isset($userData) && (int)$userData->user_verified==0) || (isset($userData)&&count($cart)==0)) 
      header("Location:".GameHeaven);

      include 'getCountry.php';
      $userCountry = correspContry($userData->user_country);
     $this->_t = "Checkout"; 
?>
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="firstName" name="user_first_name" placeholder="" value="<?=htmlentities($userData->user_first_name ?? "")?> " required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="lastName" name="user_last_name" placeholder="" value="<?=htmlentities($userData->user_last_name ?? "")?> " required>
                        <div class="invalid-feedback">
                ...
                $total = 0;
                    for($i=0;$i<count($cart);$i++)
                    {
                        ...
                        ?>
                        <input type="hidden" name="game[]" value="<?=$cart[$i]->game_id?>">
                        <input type="hidden" name="gameNames[]" value="<?=$cart[$i]->game_name?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="address" name="billing_adress1" placeholder="Adress" required>
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    <label for="address2" style="color:white">Address 2 <span class="text-muted">(Optional)</span></label>
                    <input type="text" class="form-control" id="address2" name="billing_adress2" placeholder="Apartment or suite">
                </div>

                <div class="row">
                    <div class="col-md-5 mb-3">
                        <label for="country" style="color:white">Country</label>
                        <select id="country" class="custom-select d-block w-100" name="country" required ></select>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="state" style="color:white">State</label>
                        <select name="state" class="custom-select d-block w-100" id="state" name="state" required></select>
                    </div>
                    <div class="col-md-3 mb-3">
                        <label for="zip" style="color:white">Zip</label>
                        <input type="number" class="form-control" id="zip" placeholder="" name="zip_code" required>
                        <div class="invalid-feedback">
                            Zip code required.
                        </div>
                    </div>
                ...
                <div class="mb-3">
                    <label for="phone_number" style="color:white">Phone Number <span class="text-muted">(Optional)</span></label>
